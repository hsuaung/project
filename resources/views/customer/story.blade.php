...
@section('content')
    <section class="story">
        <div class="story-content">
            <h1>Our Story</h1>
            <p>Our wonderful story starts back in 1973 when the first Monsoon boutique opened on London’s Beauchamp Place.
            </p><br>
            <p>Today, our two great sister brands have an international presence with over 1,000 stores around the world.
                Throughout
    ...
    <section class="story1">
        <div class="story1-content">
            <p>Duis congue viverra gravida. Suspendisse sed facilisis lorem. Nullam id malesuada sapien. Etiam pulvinar
                gravida
                tortor
